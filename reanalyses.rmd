...
- The samples in this dataset are matched (ie, for each pairwise comparison there is a early, mid, and late expression value). The KS test is for unmatched samples. Nonparametric tests for matched samples include the Sign test and the Wilcoxon Signed Rank Test. See, for example,  [http://sphweb.bumc.bu.edu/otlt/MPH-Modules/BS/BS704_Nonparametric/BS704_Nonparametric_print.html](this) explanation.
